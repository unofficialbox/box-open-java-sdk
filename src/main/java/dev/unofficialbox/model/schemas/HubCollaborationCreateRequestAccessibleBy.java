...
public record HubCollaborationCreateRequestAccessibleBy(
    String type,
    Optional<String> id,
    ...
    public static HubCollaborationCreateRequestAccessibleBy fromJson(Object _json) {
        java.util.Map<String, Object> _m = dev.unofficialbox.core.Json.asObject(_json);
        return new HubCollaborationCreateRequestAccessibleBy(
    ...
    public static final class Builder {
        ...
        public HubCollaborationCreateRequestAccessibleBy build() {
            return new HubCollaborationCreateRequestAccessibleBy(
                type,
                id,
                login
