...
public record EnterpriseBase(Optional<String> id, Optional<EnterpriseType> type) {
    ...
    public static EnterpriseBase fromJson(Object _json) {
        java.util.Map<String, Object> _m = dev.unofficialbox.core.Json.asObject(_json);
        return new EnterpriseBase(
