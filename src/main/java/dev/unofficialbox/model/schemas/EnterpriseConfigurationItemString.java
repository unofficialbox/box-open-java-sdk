...
public record EnterpriseConfigurationItemString(Optional<Boolean> isUsed, Tristate<String> value) {
    ...
    public static EnterpriseConfigurationItemString fromJson(Object _json) {
        java.util.Map<String, Object> _m = dev.unofficialbox.core.Json.asObject(_json);
        return new EnterpriseConfigurationItemString(
    ...
    public static final class Builder {
        ...
        public EnterpriseConfigurationItemString build() {
            return new EnterpriseConfigurationItemString(
                isUsed,
                value
            );
