...
public record PutFolderIdUpdateSharedLinkSharedLink(
    ...
    public java.util.Map<String, Object> toJson() {
        ...
        password().ifPresent(_v -> _m.put("password", _v));
    ...
    public static PutFolderIdUpdateSharedLinkSharedLink fromJson(Object _json) {
        java.util.Map<String, Object> _m = dev.unofficialbox.core.Json.asObject(_json);
        return new PutFolderIdUpdateSharedLinkSharedLink(
            ...
            (!_m.containsKey("password") || _m.get("password") == null) ? java.util.Optional.<String>empty() : java.util.Optional.of(dev.unofficialbox.core.Json.asString(_m.get("password"))),
    ...
    public static final class Builder {
        ...
        private Optional<String> password = java.util.Optional.empty();
        ...
        public PutFolderIdUpdateSharedLinkSharedLink build() {
            return new PutFolderIdUpdateSharedLinkSharedLink(
                access,
                password,
                vanityName,
