...
public record EnterpriseConfigurationContentAndSharingSharedLinkDefaultPermissionsSelected(
    Optional<Boolean> isUsed,
    Optional<SharedLinkPermissions> value) {
    ...
    public static EnterpriseConfigurationContentAndSharingSharedLinkDefaultPermissionsSelected fromJson(Object _json) {
