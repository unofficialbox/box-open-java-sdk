...
public record AiTextGenItems(String id, AiCitationType type, Optional<String> content) {
    ...
    public static AiTextGenItems fromJson(Object _json) {
        java.util.Map<String, Object> _m = dev.unofficialbox.core.Json.asObject(_json);
        return new AiTextGenItems(
