...
public record RetentionPolicies(
    Optional<List<RetentionPolicy>> entries,
    Optional<Long> limit,
    ...
    public static RetentionPolicies fromJson(Object _json) {
        java.util.Map<String, Object> _m = dev.unofficialbox.core.Json.asObject(_json);
        return new RetentionPolicies(
            (!_m.containsKey("entries") || _m.get("entries") == null) ? java.util.Optional.<List<RetentionPolicy>>empty() : java.util.Optional.of(dev.unofficialbox.core.Json.decodeList(_m.get("entries"), _x0 -> (_x0 == null ? null : RetentionPolicy.fromJson(_x0)))),
    ...
    public static final class Builder {
        private Optional<List<RetentionPolicy>> entries = java.util.Optional.empty();
