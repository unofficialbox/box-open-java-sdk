...
public record EnterpriseConfigurationSecurityLastPasswordResetAt(
    Optional<Boolean> isUsed,
    Tristate<OffsetDateTime> value) {
    public java.util.Map<String, Object> toJson() {
        java.util.Map<String, Object> _m = new java.util.LinkedHashMap<>();
        isUsed().ifPresent(_v -> _m.put("is_used", _v));
        if (value().isPresent()) { _m.put("value", (value().value() == null ? null : value().value().toString())); }
        else if (value().isNull()) { _m.put("value", null); }
        return _m;
    }

    public static EnterpriseConfigurationSecurityLastPasswordResetAt fromJson(Object _json) {
